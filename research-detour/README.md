...
- The target=360000 segment is the backoff/slow rehome pass; it reverses and finishes near the top. You can see the smaller steps and the final settle around 360000.
...
The behavior is consistent with sub_53704: a fast move to trip the endstop, then slow rehome/backoff, then a final settle.
